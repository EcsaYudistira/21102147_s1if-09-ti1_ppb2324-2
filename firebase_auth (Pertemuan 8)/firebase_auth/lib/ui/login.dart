...
import 'package:firebase_auth_09/ui/phone_auth_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> { 
  ...
  Future<UserCredential> signInWithGoogle() async {
    ...
    return await FirebaseAuth.instance.signInWithCredential(Credential).then((value) async => await Navigator.pushAndRemoveUntil(
